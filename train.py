...
parser.add_argument('--bank_n', type=int, default=10)
parser.add_argument('--h', type=int, default=1)
parser.add_argument('--epochs', type=int, default=500)
parser.add_argument('--encoder_mom', type=float, default=0.9)
parser.add_argument('--loss_type', type=float, default='nce', help="Wether to run self-supervised encoder or")
...
parser.add_argument('--ds_path', type=str, default='default_run', help='Path of dataset')
...
def main():
    ...
    train_loader, test_loader, num_classes = \
        build_dataset(dataset=dataset, batch_size=args.batch_size, nmb_workers=args.nmb_workers,
                      ...
                      min_scale_crops=args.min_scale_crops, max_scale_crops=args.max_scale_crops, a=0.5)  # , a=0.5)
    ...
    task(model, args.lr, train_loader, args.nmb_crops, test_loader, logger,
         checkpointer, args.output_dir, torch_device, args.warmup, args.epochs, args.amp, args.lam, args.wd, args.larc)
    # '''
    train_loader, test_loader, num_classes = \
    ...
    train_classifiers(model, args.lr, train_loader, [1], test_loader, logger, checkpointer, args.output_dir,
                      torch_device, args.warmup, 200, args.amp, args.lam, args.wd, args.larc)
